...
public class Login extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response)
        ...
        if (usuario == null || usuario.getEmail().equals("") || (usuario.getEmail() == null ? email != null : !usuario.getEmail().equals(email))){
            ...
            sessao.setAttribute("sessaoEmail", usuario.getEmail());
            sessao.setAttribute("sessaoFoto", usuario.getFoto());
